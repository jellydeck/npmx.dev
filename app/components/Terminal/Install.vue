      ...
      <div class="px-3 pt-2 pb-3 sm:px-4 sm:pt-3 sm:pb-4 space-y-1 overflow-x-auto">
        ...
        <template v-if="typesPackageName && showTypesInInstall">
          ...
          >
            ...
            <NuxtLink
              :to="`/${typesPackageName}`"
              class="text-fg-subtle hover:text-fg-muted text-xs transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70 rounded"
