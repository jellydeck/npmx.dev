...
<template>
  <section v-if="isConnected" class="bg-bg-subtle border border-border rounded-lg overflow-hidden">
    ...
    <div class="flex items-center justify-between p-4 border-b border-border">
      ...
      <button
        type="button"
        class="p-1.5 text-fg-muted hover:text-fg transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
    ...
    <div class="flex flex-wrap items-center gap-2 p-3 border-b border-border bg-bg">
      <div class="flex-1 min-w-[150px] relative">
        ...
        <input
          ...
          v-bind="noCorrect"
          class="w-full ps-7 pe-2 py-1.5 font-mono text-sm bg-bg-subtle border border-border rounded text-fg placeholder:text-fg-subtle transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
        />
      </div>
      <div
      ...
      >
        <button
          ...
          :key="role"
          type="button"
          class="px-2 py-1 font-mono text-xs rounded transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
      ...
      <div v-if="teamNames.length > 0">
        ...
        <select
          ...
          v-model="filterTeam"
          name="team-filter"
          class="px-2 py-1 font-mono text-xs bg-bg-subtle border border-border rounded text-fg transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
        >
      ...
      >
        <button
          type="button"
          class="px-2 py-1 font-mono rounded transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-1">
            ...
            <select
              ...
              class="px-1.5 py-0.5 font-mono text-xs bg-bg-subtle border border-border rounded text-fg transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70 cursor-pointer"
              @change="
                handleChangeRole(
                  member.name,
            ...
            <button
              type="button"
              class="p-1 text-fg-subtle hover:text-red-400 transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
        ...
        <div v-if="member.teams.length > 0" class="flex flex-wrap gap-1 ps-0">
          <button
            ...
            :key="team"
            type="button"
            class="inline-flex items-center gap-1 px-1.5 py-0.5 font-mono text-xs text-fg-muted border border-border rounded hover:text-fg hover:border-border-hover transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
    ...
    <div class="p-3 border-t border-border">
      <div v-if="showAddMember">
        <form class="space-y-2" @submit.prevent="handleAddMember">
          ...
          <input
            ...
            v-bind="noCorrect"
            class="w-full px-2 py-1.5 font-mono text-sm bg-bg border border-border rounded text-fg placeholder:text-fg-subtle transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
          />
          <div class="flex items-center gap-2">
            ...
            <select
              ...
              class="flex-1 px-2 py-1.5 font-mono text-sm bg-bg border border-border rounded text-fg transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
            >
              <option value="developer">{{ $t('org.members.role.developer') }}</option>
              <option value="admin">{{ $t('org.members.role.admin') }}</option>
              <option value="owner">{{ $t('org.members.role.owner') }}</option>
            ...
            <button
              ...
              class="px-3 py-1.5 font-mono text-xs text-bg bg-fg rounded transition-all duration-200 hover:bg-fg/90 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
            >
              {{ isAddingMember ? '…' : $t('org.members.add_button') }}
            </button>
            <button
              type="button"
              class="p-1.5 text-fg-subtle hover:text-fg transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
      ...
      <button
        v-else
        type="button"
        class="w-full px-3 py-2 font-mono text-sm text-fg-muted bg-bg border border-border rounded transition-colors duration-200 hover:text-fg hover:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
