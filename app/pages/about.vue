  ...
  <main class="container flex-1 py-12 sm:py-16">
    <article class="max-w-2xl mx-auto">
      ...
      <footer class="mt-16 pt-8 border-t border-border">
        <NuxtLink
          to="/"
          class="inline-flex items-center gap-2 font-mono text-sm text-fg-muted hover:text-fg transition-[color] duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70"
        >
